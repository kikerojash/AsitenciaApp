...
public class ColumnaAsistenciaPuntualHolder  extends CeldasViewHolder<MotivosAsistenciaUi> {
    @BindView(R.id.txtTitle)
    TextView textViewTitulo;

    public ColumnaAsistenciaPuntualHolder(View itemView) {
        super(itemView);
    ...
    public void bind(MotivosAsistenciaUi cell) {
        textViewTitulo.setText("Puntual");
    }
}

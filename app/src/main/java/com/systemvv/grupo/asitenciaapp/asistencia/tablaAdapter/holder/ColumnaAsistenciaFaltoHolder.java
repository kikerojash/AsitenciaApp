...
public class ColumnaAsistenciaFaltoHolder extends CeldasViewHolder<MotivosAsistenciaUi> {
    @BindView(R.id.txtTitle)
    TextView textViewTitulo;

    public ColumnaAsistenciaFaltoHolder(View itemView) {
        super(itemView);

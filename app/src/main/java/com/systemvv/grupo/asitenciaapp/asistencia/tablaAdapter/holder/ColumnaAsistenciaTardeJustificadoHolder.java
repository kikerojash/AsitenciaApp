...
public class ColumnaAsistenciaTardeJustificadoHolder extends CeldasViewHolder<MotivosAsistenciaUi> {
    @BindView(R.id.txtTitle)
    TextView textViewTitulo;

    public ColumnaAsistenciaTardeJustificadoHolder(View itemView) {
        super(itemView);
    ...
    public void bind(MotivosAsistenciaUi cell) {
        textViewTitulo.setText("Justificado");
    }
}

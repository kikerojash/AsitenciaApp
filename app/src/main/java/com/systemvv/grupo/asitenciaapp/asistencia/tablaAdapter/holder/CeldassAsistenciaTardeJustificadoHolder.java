...
public class CeldassAsistenciaTardeJustificadoHolder extends CeldasViewHolder<AsistenciaUi> {
    ...
    public CeldassAsistenciaTardeJustificadoHolder(View itemView) {
        super(itemView);
    ...
    public void bind(AsistenciaUi cell) {
        ...
        if (cell.isPintar()){
            fondo.setBackgroundColor(itemView.getResources().getColor(R.color.md_brown_200));
        }else {
